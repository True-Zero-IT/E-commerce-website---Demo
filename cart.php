                ...
                <tbody>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="images/products/<?php echo $p['image']; ?>" alt="Image" class="img-fluid">
                    </td>
                    ...
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
                        ...
                        <input type="text" class="form-control text-center" value="<?= $p['cart_qty'] ?>" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1">
                    ...
                    <td>$<?= ($p['product_price'] * $p['cart_qty']) ?></td>
                    <td><a href="cart_del.php?del_id=<?= $p['cart_id'] ?>" onclick=" return confirm('Are You Sure ?')" class="btn btn-primary btn-sm">X</a></td>
                  </tr> 
                  <?php 
